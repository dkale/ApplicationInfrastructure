      ...
      <body style="font-weight:bold !important">
        <div class="page-header">
          <img style="height: 75px;" align="center" class="logo">
            ...
            <span style="color:#19a0dd">Open Ticket</span>
          </img>
        </div>
        ...
        <div class="body-content" style="width:1000px">
          ...
          <table>
            <tbody>
              ...
              <tr>
                <td class="loan-label">
                  Interfund Lending Rate:
                </td>
                <td class="loan-value">
                  <xsl:value-of select='format-number(LoanTicketViewModel/LendingRate, "###,###.0000")' />%
                </td>
              </tr>
              <tr>
                <td class="loan-label">Borrowed Interest:</td>
                <td class="loan-value">TBD</td>
              </tr>
              <tr>
                <td class="loan-label">Maturity Amount:</td>
                <td class="loan-value">TBD</td>
              </tr>
              <tr>
                <td class="loan-label">
                ...
                <td class="loan-value">
                  <xsl:value-of select='format-number(LoanTicketViewModel/TreasuryRate, "###,###.0000")' />%
                </td>
              </tr>
            </tbody>
          </table>
